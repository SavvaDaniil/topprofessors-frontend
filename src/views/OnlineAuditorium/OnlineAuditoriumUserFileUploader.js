...
export default class OnlineAuditoriumUserFileUploader extends Component {
    constructor(props){
        super(props);
        this.state = {
            isLoading : false,
    ...
    userFileUpload(){
        ...
        fetch(constant.url + "/api/online_auditorium_message/user/new_file/", 
            {
                method : "POST",
                headers : {
        ...
        return (
            <div className="col-12 row">
                ...
                <div className="col-12 col-lg-4 col-md-4 col-sm-12">
                    <div className="online-auditorium-user-file-form">
